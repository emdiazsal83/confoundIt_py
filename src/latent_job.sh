...
#SBATCH --job-name=latentnoise_krr
#SBATCH --output=/home/emiliano/latentnoise_krr/log/latentNoise_%A_%a.out
...
# DO STUFF
srun --ntasks 1 --nodes 1  python -u slurm_script.py --save v0 --job $SLURM_ARRAY_TASK_ID --offset 68000 --server erc
